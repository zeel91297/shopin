...
<?php
    ...
    $sql="select * from product_tbl where prod_id=".$_proid;
...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="<?php echo $row["prod_img1"]; ?>">
...
<div class="col-md-7 single-top-in">
			    ...
			    <div class="price_single">
				  <span class="reducedfrom item_price">$<?php echo $row["prod_price"]; ?></span>
				 <a href="#">click for offer</a>
				 <div class="clearfix"></div>
				</div>
				<h4 class="quick">Quick Overview:</h4>
				<p class="quick_desc"> <?php echo $row["prod_desc"]; ?></p>
				 <div class="quantity"> 
